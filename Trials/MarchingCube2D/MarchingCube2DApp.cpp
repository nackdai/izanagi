#include "MarchingCube2DApp.h"

MarchingCube2DApp::MarchingCube2DApp()
{
    m_Cube = IZ_NULL;
    m_Img = IZ_NULL;
    m_Shader = IZ_NULL;
...
// 初期化.
IZ_BOOL MarchingCube2DApp::InitInternal(
...
// 解放.
void MarchingCube2DApp::ReleaseInternal()
{
    SAFE_RELEASE(m_Cube);
    SAFE_RELEASE(m_Img);
...
// 更新.
void MarchingCube2DApp::UpdateInternal(izanagi::graph::CGraphicsDevice* device)
{
    GetCamera().Update();
...
// 描画.
void MarchingCube2DApp::RenderInternal(izanagi::graph::CGraphicsDevice* device)
{
