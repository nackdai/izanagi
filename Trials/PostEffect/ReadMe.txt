================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PostEffect プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PostEffect には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PostEffect アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PostEffect.h
   ...
   CPostEffectApp アプリケーション クラスを宣言します。

PostEffect.cpp
   これは、アプリケーション クラス CPostEffectApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PostEffect.ico
   ...
   アイコンはメイン リソース ファイル PostEffect.rc に含まれていま
   す。
...
StdAfx.h, StdAfx.cpp
   ...
   PostEffect.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
