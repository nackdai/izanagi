...
* 復号化
*/
IZ_BOOL CCompressRangeCoderDecoder::Decode(
	SDesc* pDesc,
	IInputStream* pInput,
	IZ_UINT nTotal,
...
// シンボルの出現位置を計算する
IZ_UINT CCompressRangeCoderDecoder::ComputeSimbolPos(
	IInputStream* pInput,
	IZ_UINT nTotal)
{
	// Low と Range の正規化
...
// Low と Range の正規化
IZ_BOOL CCompressRangeCoderDecoder::Normalize(IInputStream* pInput)
{
...
// 復号化
void CCompressRangeCoderDecoder::Decode(
	IZ_UINT nLow,
	IZ_UINT nRange,
	IZ_UINT nTotal)
{
