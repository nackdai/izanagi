...
namespace graph
{
    ...
    enum E_GRAPH_TEX_FILTER {
        ...
        E_GRAPH_TEX_FILTER_NEAREST_MIPMAP_NEAREST,     ///< Only for OpenGL...
        E_GRAPH_TEX_FILTER_LINEAR_MIPMAP_NEAREST,      ///< Only for OpenGL...
        E_GRAPH_TEX_FILTER_NEAREST_MIPMAP_LINEAR,      ///< Only for OpenGL...
        E_GRAPH_TEX_FILTER_LINEAR_MIPMAP_LINEAR,       ///< Only for OpenGL...
    ...
    enum E_GRAPH_2D_RENDER_OP {
        ...
        E_GRAPH_2D_RENDER_OP_TEX_AS_DETPH,      ///< Draw texture as depth.
