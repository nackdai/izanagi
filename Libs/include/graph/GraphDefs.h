...
namespace uranus {
	...
	*/
	...
	enum E_GRAPH_ALPHA_BLEND {
		// 通常のアルファブレンド
		E_GRAPH_ALPHA_BLEND_NORMAL   = UN_GRAPH_ALPHA_BLEND_VAL(D3DBLENDOP_ADD,         D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA),

		// 加算
		E_GRAPH_ALPHA_BLEND_CsAs_Cd  = UN_GRAPH_ALPHA_BLEND_VAL(D3DBLENDOP_ADD,         D3DBLEND_SRCALPHA, D3DBLEND_ONE),

		E_GRAPH_ALPHA_BLEND_Cs_Cd    = UN_GRAPH_ALPHA_BLEND_VAL(D3DBLENDOP_ADD,         D3DBLEND_ONE,      D3DBLEND_ONE),
		E_GRAPH_ALPHA_BLEND_NCsAs_Cd = UN_GRAPH_ALPHA_BLEND_VAL(D3DBLENDOP_REVSUBTRACT, D3DBLEND_SRCALPHA, D3DBLEND_ONE),
		E_GRAPH_ALPHA_BLEND_NCs_Cd   = UN_GRAPH_ALPHA_BLEND_VAL(D3DBLENDOP_REVSUBTRACT, D3DBLEND_ONE,      D3DBLEND_ONE),
