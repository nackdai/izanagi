    ...
    */
    ...
    public:
        enum {
            ...
            YELLOW   = IZ_COLOR_RGBA(0xff, 0xff, 0x00, 0xff),
            CYAN     = IZ_COLOR_RGBA(0x00, 0xff, 0xff, 0xff),
            FUCHSIA  = IZ_COLOR_RGBA(0xff, 0x00, 0xff, 0xff),
            OLIVE    = IZ_COLOR_RGBA(0x80, 0x80, 0x00, 0xff),
            PURPLE   = IZ_COLOR_RGBA(0x80, 0x00, 0x80, 0xff),
            SALMON   = IZ_COLOR_RGBA(0xFA, 0x80, 0x72, 0xff),
            SKYBLUE  = IZ_COLOR_RGBA(0x87, 0xCE, 0xEB, 0xff),
            VIOLET   = IZ_COLOR_RGBA(0xEE, 0x82, 0xEE, 0xff),
            ORANGE   = IZ_COLOR_RGBA(0xFF, 0xA5, 0x00, 0xff),
            DEEPPINK = IZ_COLOR_RGBA(0xFF, 0x14, 0x93, 0xff),
        };
