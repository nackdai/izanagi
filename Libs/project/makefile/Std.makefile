...
create_folders:
	mkdir -p gccDebug_GLES2/source/std
	mkdir -p gccDebug_GLES2/source/std/allocator
	mkdir -p gccDebug_GLES2/source/std/binding
	mkdir -p ../lib/gccDebug_GLES2
	mkdir -p gccRelease_GLES2/source/std
	mkdir -p gccRelease_GLES2/source/std/allocator
	mkdir -p gccRelease_GLES2/source/std/binding
	mkdir -p ../lib/gccRelease_GLES2

# Cleans intermediate and output files (objects, libraries, executables)...
.PHONY: clean
clean:
	rm -f gccDebug_GLES2/source/std/*.o
	rm -f gccDebug_GLES2/source/std/*.d
	rm -f gccDebug_GLES2/source/std/allocator/*.o
	rm -f gccDebug_GLES2/source/std/allocator/*.d
	rm -f gccDebug_GLES2/source/std/binding/*.o
	rm -f gccDebug_GLES2/source/std/binding/*.d
	rm -f ../lib/gccDebug_GLES2/libStd.a
	rm -f gccRelease_GLES2/source/std/*.o
	rm -f gccRelease_GLES2/source/std/*.d
	rm -f gccRelease_GLES2/source/std/allocator/*.o
	rm -f gccRelease_GLES2/source/std/allocator/*.d
	rm -f gccRelease_GLES2/source/std/binding/*.o
	rm -f gccRelease_GLES2/source/std/binding/*.d
	rm -f ../lib/gccRelease_GLES2/libStd.a
