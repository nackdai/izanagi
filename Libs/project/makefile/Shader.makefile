...
create_folders:
	mkdir -p gccDebug_GLES2/source/shader
	mkdir -p gccDebug_GLES2/source/shader/base
	mkdir -p gccDebug_GLES2/source/shader/base/table
	mkdir -p ../lib/gccDebug_GLES2
	mkdir -p gccRelease_GLES2/source/shader
	mkdir -p gccRelease_GLES2/source/shader/base
	mkdir -p gccRelease_GLES2/source/shader/base/table
	mkdir -p ../lib/gccRelease_GLES2

# Cleans intermediate and output files (objects, libraries, executables)...
.PHONY: clean
clean:
	rm -f gccDebug_GLES2/source/shader/*.o
	rm -f gccDebug_GLES2/source/shader/*.d
	rm -f gccDebug_GLES2/source/shader/base/*.o
	rm -f gccDebug_GLES2/source/shader/base/*.d
	rm -f gccDebug_GLES2/source/shader/base/table/*.o
	rm -f gccDebug_GLES2/source/shader/base/table/*.d
	rm -f ../lib/gccDebug_GLES2/libShader.a
	rm -f gccRelease_GLES2/source/shader/*.o
	rm -f gccRelease_GLES2/source/shader/*.d
	rm -f gccRelease_GLES2/source/shader/base/*.o
	rm -f gccRelease_GLES2/source/shader/base/*.d
	rm -f gccRelease_GLES2/source/shader/base/table/*.o
	rm -f gccRelease_GLES2/source/shader/base/table/*.d
	rm -f ../lib/gccRelease_GLES2/libShader.a
