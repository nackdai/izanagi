...
create_folders:
	mkdir -p gccDebug_GLES2/source/debugutil
	mkdir -p gccDebug_GLES2/source/debugutil/mesh
	mkdir -p ../lib/gccDebug_GLES2
	mkdir -p gccRelease_GLES2/source/debugutil
	mkdir -p gccRelease_GLES2/source/debugutil/mesh
	mkdir -p ../lib/gccRelease_GLES2

# Cleans intermediate and output files (objects, libraries, executables)...
.PHONY: clean
clean:
	rm -f gccDebug_GLES2/source/debugutil/*.o
	rm -f gccDebug_GLES2/source/debugutil/*.d
	rm -f gccDebug_GLES2/source/debugutil/mesh/*.o
	rm -f gccDebug_GLES2/source/debugutil/mesh/*.d
	rm -f ../lib/gccDebug_GLES2/libDebugUtil.a
	rm -f gccRelease_GLES2/source/debugutil/*.o
	rm -f gccRelease_GLES2/source/debugutil/*.d
	rm -f gccRelease_GLES2/source/debugutil/mesh/*.o
	rm -f gccRelease_GLES2/source/debugutil/mesh/*.d
	rm -f ../lib/gccRelease_GLES2/libDebugUtil.a
