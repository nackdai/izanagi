...
create_folders:
	mkdir -p gccDebug_GLES2/source/math
	mkdir -p gccDebug_GLES2/source/math/SFMT
	mkdir -p ../lib/gccDebug_GLES2
	mkdir -p gccRelease_GLES2/source/math
	mkdir -p gccRelease_GLES2/source/math/SFMT
	mkdir -p ../lib/gccRelease_GLES2

# Cleans intermediate and output files (objects, libraries, executables)...
.PHONY: clean
clean:
	rm -f gccDebug_GLES2/source/math/*.o
	rm -f gccDebug_GLES2/source/math/*.d
	rm -f gccDebug_GLES2/source/math/SFMT/*.o
	rm -f gccDebug_GLES2/source/math/SFMT/*.d
	rm -f ../lib/gccDebug_GLES2/libMath.a
	rm -f gccRelease_GLES2/source/math/*.o
	rm -f gccRelease_GLES2/source/math/*.d
	rm -f gccRelease_GLES2/source/math/SFMT/*.o
	rm -f gccRelease_GLES2/source/math/SFMT/*.d
	rm -f ../lib/gccRelease_GLES2/libMath.a
