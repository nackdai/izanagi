...
Debug_GLES2: create_folders 
	ar rcs ../lib/gccDebug_GLES2/libTerra.a  $(Debug_GLES2_Implicitly_Linked_Objects)

# Builds the Release_GLES2 configuration...
.PHONY: Release_GLES2
Release_GLES2: create_folders 
	ar rcs ../lib/gccRelease_GLES2/libTerra.a  $(Release_GLES2_Implicitly_Linked_Objects)
...
clean:
	...
	rm -f ../lib/gccDebug_GLES2/libTerra.a
	rm -f gccRelease_GLES2/*.o
	rm -f gccRelease_GLES2/*.d
	rm -f ../lib/gccRelease_GLES2/libTerra.a
