...
create_folders:
	mkdir -p gccDebug_GLES2/source/threadmodel
	mkdir -p ../lib/gccDebug_GLES2
	mkdir -p gccRelease_GLES2/source/threadmodel
	mkdir -p ../lib/gccRelease_GLES2

# Cleans intermediate and output files (objects, libraries, executables)...
.PHONY: clean
clean:
	rm -f gccDebug_GLES2/source/threadmodel/*.o
	rm -f gccDebug_GLES2/source/threadmodel/*.d
	rm -f ../lib/gccDebug_GLES2/libThreadModel.a
	rm -f gccRelease_GLES2/source/threadmodel/*.o
	rm -f gccRelease_GLES2/source/threadmodel/*.d
	rm -f ../lib/gccRelease_GLES2/libThreadModel.a
