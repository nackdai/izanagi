...
BEGIN_MESSAGE_MAP(CShaderApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CShaderApp::OnAppAbout)
END_MESSAGE_MAP()


// CShaderApp コンストラクション
...
BOOL CShaderApp::OnIdle(LONG lCount)
{
