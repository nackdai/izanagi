...
BEGIN_MESSAGE_MAP(CMtrlApp, CWinApp)
...
// 唯一の CMtrlApp オブジェクトです。

CMtrlApp theApp;

// CMtrlApp 初期化

BOOL CMtrlApp::InitInstance()
{
...
BOOL CMtrlApp::OnIdle(LONG lCount)
{
