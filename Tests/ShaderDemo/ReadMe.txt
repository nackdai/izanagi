================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ShaderTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ShaderTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ShaderTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ShaderTest.h
   ...
   CDebugMeshApp アプリケーション クラスを宣言します。

ShaderTest.cpp
   これは、アプリケーション クラス CDebugMeshApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ShaderTest.ico
   ...
   アイコンはメイン リソース ファイル ShaderTest.rc に含まれていま
   す。
...
StdAfx.h, StdAfx.cpp
   ...
   ShaderTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
