// PostEffect.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CPostEffectApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CPostEffectApp::OnAppAbout)
END_MESSAGE_MAP()


// CPostEffectApp コンストラクション
...
// 唯一の CPostEffectApp オブジェクトです。

CPostEffectApp theApp;


// CPostEffectApp 初期化

BOOL CPostEffectApp::InitInstance()
{
...
void CPostEffectApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
BOOL CPostEffectApp::OnIdle(LONG lCount)
{
