#include "ColorCollectionApp.h"

ColorCollectionApp::ColorCollectionApp()
{
}
...
// 初期化.
IZ_BOOL ColorCollectionApp::InitInternal(
    ...
    izanagi::sample::CSampleCamera& camera)
{
    ...
    {
        izanagi::CFileInputStream in;
        VRETURN(in.Open("data/ColorCollectionShader.shd"));
...
// 解放.
void ColorCollectionApp::ReleaseInternal()
{
    SAFE_RELEASE(m_Img);
    SAFE_RELEASE(m_shd);
}
...
// 更新.
void ColorCollectionApp::UpdateInternal(izanagi::graph::CGraphicsDevice* device)
{
    // Nothing is done...
}

// 描画.
void ColorCollectionApp::RenderInternal(izanagi::graph::CGraphicsDevice* device)
{
