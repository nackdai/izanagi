...
Debug_GLUT_Libraries=-Wl,--no-as-needed -Wl,--start-group -lShader -lPostEffect -lMath -lSceneGraph -lSystem -lDebugUtil -lGraph -lStd -lSampleKit -lglut -lGLU -lGLEW -lGL -lX11 -lXxf86vm -lXi  -Wl,--end-group
