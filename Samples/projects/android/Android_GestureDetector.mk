...
include $(CLEAR_VARS)
LOCAL_MODULE := prebuild-libUI
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../Libs/project/lib/libUI.a
...
LOCAL_MODULE     := libGestureDetector
...
LOCAL_SRC_FILES  := ../../GestureDetector/main.cpp

LOCAL_WHOLE_STATIC_LIBRARIES := prebuild-libUI \
prebuild-libThreadModel \
prebuild-libMath \
