...
include $(CLEAR_VARS)
LOCAL_MODULE := prebuild-libAnimation
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../Libs/project/lib/libAnimation.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES  := ../../MotionInterp/CustomInterp.cpp \
../../MotionInterp/main.cpp \
../../MotionInterp/MotionInterpApp.cpp

LOCAL_WHOLE_STATIC_LIBRARIES := prebuild-libShader \
prebuild-libAnimation \
prebuild-libMath \
