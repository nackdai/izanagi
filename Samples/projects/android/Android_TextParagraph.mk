...
include $(CLEAR_VARS)
LOCAL_MODULE := prebuild-libText
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../Libs/project/lib/libText.a
...
include $(CLEAR_VARS)
LOCAL_MODULE := prebuild-libfreetype
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../Libs/project/lib/libfreetype.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES  := ../../TextParagraph/TextParagraph.cpp

LOCAL_WHOLE_STATIC_LIBRARIES := prebuild-libText \
prebuild-libMath \
